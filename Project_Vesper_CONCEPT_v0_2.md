...
| 後退フェイント斬り | 可 | 短く止める、または止める | 状況次第 | 中〜大 | あり |
| 掴み | 不可 | なし | なし | なし | なし |
...
UIに DEFLECT! / RHYTHM PARRY! を表示
戦闘ログに rhythmParryCount / maxRhythmParryChain を追加
```
